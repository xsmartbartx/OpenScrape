...
required_names="POSTGRES_USER POSTGRES_PASSWORD POSTGRES_DB REDIS_PASSWORD MINIO_ROOT_USER MINIO_ROOT_PASSWORD PUBLIC_DOMAIN APP_URL NEXT_PUBLIC_API_URL"
