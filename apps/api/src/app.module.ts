...
@Module({
  ...
  controllers: [AppController, ApiKeysController, AuditController, AuthController, HealthController, RobotsController, RunLogsController, SchedulesController, UsageController, WorkspaceController],
  providers: [
    PrismaService,
    AuditService,
